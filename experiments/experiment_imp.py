    ...
    def execute_experiment(self):
        ...
        for n in range(self.args.net_count):
            for p in range(0, self.args.prune_count+1):
                ...
                self.nets[n], self.loss_hists[n,p], self.val_acc_hists[n,p], self.test_acc_hists[n,p], self.val_acc_hists_epoch[n,p], self.test_acc_hists_epoch[n,p] = self.trainer.train_net(self.nets[n], self.args.epoch_count, self.args.plot_step)
